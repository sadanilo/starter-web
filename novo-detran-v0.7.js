(function () {
  ...
  if (
    ...
    "https://sistemas.detran.pi.gov.br/renainf-web/restrito/consulta/baseNacional/infracao/porPlaca/consulta.jsf"
  ) {
    function buildSummary() {
      ...
      let resumo = $(
        "#formConsulta401\\:j_idt76\\:tabview > ul > li.ui-state-default.ui-corner-top.ui-tabs-selected.ui-state-active"
      ).clone(true);
    ...
    function updateInfoInputsValues(dataSource) {
      ...
      dataSource.querySelector(
        "#linkAtendimento"
      ).href = `http://atendimento.detran.pi.gov.br/view/pesquisa/pesquisa.jsf?nit=${
      ...
      dataSource.querySelector("#infoPlacaVeiculo").value = dataSource.querySelector(
        "#formConsulta401\\:j_idt76\\:tabview\\:j_idt83"
      ).value;
      dataSource.querySelector("#infoRenavamVeiculo").value = dataSource.querySelector(
        "#formConsulta401\\:j_idt76\\:tabview\\:j_idt288"
      ).value;
      dataSource.querySelector("#infoNumeroAuto").value = dataSource.querySelector(
        "#formConsulta401\\:j_idt76\\:tabview\\:j_idt94"
      ).value;
      dataSource.querySelector("#infoDataAutuacao").value = dataSource.querySelector(
        "#formConsulta401\\:j_idt76\\:tabview\\:j_idt183"
      ).value;
      dataSource.querySelector("#infoDataDefesaPrevia").value = dataSource.querySelector(
        "#formConsulta401\\:j_idt76\\:tabview\\:j_idt186"
      ).value;
      dataSource.querySelector("#infoNumeroNIT").value = dataSource.querySelector(
        "#formConsulta401\\:j_idt76\\:tabview\\:j_idt201"
      ).value;
      dataSource.querySelector("#infoDataPenalizacao").value = dataSource.querySelector(
        "#formConsulta401\\:j_idt76\\:tabview\\:j_idt204"
      ).value;
      dataSource.querySelector("#infoDataVencBoleto").value = dataSource.querySelector(
        "#formConsulta401\\:j_idt76\\:tabview\\:j_idt207"
      ).value;
      dataSource.querySelector("#infoUfPagamento").value = dataSource.querySelector(
        "#formConsulta401\\:j_idt76\\:tabview\\:j_idt225"
      ).value;
      dataSource.querySelector("#infoDataPagamento").value = dataSource.querySelector(
        "#formConsulta401\\:j_idt76\\:tabview\\:j_idt228"
      ).value;
      dataSource.querySelector("#infoValorPagamento").value = dataSource.querySelector(
        "#formConsulta401\\:j_idt76\\:tabview\\:j_idt231"
      ).value;
      dataSource.querySelector("#infoDataBaixaPAgamento").value = dataSource.querySelector(
        "#formConsulta401\\:j_idt76\\:tabview\\:j_idt234"
      ).value;
      dataSource.querySelector("#infoTipoOcorrencia").value = dataSource.querySelector(
        "#formConsulta401\\:j_idt76\\:tabview\\:j_idt258"
      ).value;
      dataSource.querySelector("#infoOrigemOcorrencia").value = dataSource.querySelector(
        "#formConsulta401\\:j_idt76\\:tabview\\:j_idt261"
      ).value;
      dataSource.querySelector("#infoDataOcorrencia").value = dataSource.querySelector(
        "#formConsulta401\\:j_idt76\\:tabview\\:j_idt267"
      ).value;
    }
  ...
  if (
    ...
    fillButton.onclick = function (e) {
      e.preventDefault();
      let dataInfracao = convertFromStringToDate(
        document.querySelector("#formCreateNotificacaoAutuacao\\:j_idt53").value
      );
      document.querySelector("#formCreateNotificacaoAutuacao\\:datahHoraEmissaoNotificacao_input").value = addDays(
        dataInfracao,
        32
      ).toLocaleDateString();
      document.querySelector("#formCreateNotificacaoAutuacao\\:dataLimiteDefesa_input").value = addDays(
        dataInfracao,
        62
      ).toLocaleDateString();
    };
  ...
  if (
    ...
    fillButton.onclick = function (e) {
      ...
      console.log(today);
      document.querySelector("#formCreateNotificacaoPenalidade\\:dataHoraEmissaoNotificacao_input").value =
      ...
      document
        .querySelector(
          "#formCreateNotificacaoPenalidade\\:indicadorExigibilidade > div.ui-chkbox-box.ui-widget.ui-corner-all.ui-state-default"
        )
      ...
      document.querySelector("#formCreateNotificacaoPenalidade\\:tipoPenalidade_label").textContent =
  ...
  if (
    window.location.host === "atendimento.detran.pi.gov.br" &&
    window.location.pathname === "/view/pesquisa/pesquisa.jsf"
  ) {
    const urlParams = new URLSearchParams(window.location.search);
  ...
  if (
    ...
    botaoPreencheCancelamentoAutuador.onclick = function (e) {
      ...
      document.querySelector("#formCreateOcorrencia\\:observacoes").innerText =
        "Cancelamento por deferimento de recurso";
    ...
    waitForKeyElements("#formCreateOcorrencia\\:j_idt134", function (elem) {
      ...
      document
        .querySelector("#formCreateOcorrencia\\:j_idt117_content > div > div:nth-child(2) > span")
        .append(botaoNumeroProcesso);
      document.querySelector("#formCreateOcorrencia\\:j_idt117_content > div > div:nth-child(2) > span").style =
        "display:flex";
    });
  }
})();
